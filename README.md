...
DATABASE_URL_MARIA_DB = mariadb+mariadbconnector://username:password@host:3306/database_name
API_KEY = myapikey
POOL_SIZE = 20
MAX_OVERFLOW = 0
POOL_TIMEOUT = 30
...
export DATABASE_URL_MARIA_DB = mariadb+mariadbconnector://username:password@host:3306/database_name
